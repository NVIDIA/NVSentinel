...
def main():
    ...
    def pattern_to_branch(pattern: str) -> str:
    ...
    def create_or_find_mr(gitlab_url: str, project_path: str, headers: Dict[str, str],
                        branch_name: str, pattern_name: str, version: str,
                        cluster_names: List[str], pattern_feature_flags: Dict[str, Any]) -> Dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        for pattern_data in pattern_data_list:
            ...
            branch_name = pattern_to_branch(pattern_name)
