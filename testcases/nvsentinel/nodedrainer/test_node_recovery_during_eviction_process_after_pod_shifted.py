...
# from testcases.utils.case_info_utils import case_decorator
...
#     ):
#         """
#         Test case of NVsentinel Fault Notification: 
#         Node recovery during pod eviction process after
#         the pod is shifted to another node
#         """
...
#             os.getcwd(), "data", "cli", "nvsentinel", "immediate-fault-cm.yaml"
#         )
...
#         self.step_manager.print_header(
#             "Checking the node-drainer pod log. The log should contain the message of the node is cordoned"
#         )
#         self.verify_node_drainer_pod_log(
#             expected_messages=[
...
#         self.step_manager.print_header("Checking the node-drainer pod log again")
#         self.verify_node_drainer_pod_log(
#             expected_messages=[
#                 f'"Pod not evicted" node="{self.node_name}" name="{target_busybox_pod_name}" namespace="busybox"',
#                 f'"Pod not evicted" node="{self.node_name}" name="{job_pod_name}" namespace="{self.default_namespace}"',
#             ]
#         )
