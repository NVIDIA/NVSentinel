...
// DatabaseStore implements the Store interface using store-client-sdk.
...
// NewStore creates a new database store client using store-client-sdk.
func NewStore(ctx context.Context, databaseClientCertMountPath *string) (*DatabaseStore, error) {
	...
	// This approach encapsulates MongoDB-specific environment variables within store-client-sdk
	...
	slog.Info("Database client initialized successfully using store-client-sdk",
		"collection", databaseCollection)

	// Note: Index creation is not directly supported by store-client-sdk's DatabaseClient interface.
...
// executeUpsert performs the UpsertDocument with retries for the given merged event using store-client-sdk.
...
func (s *DatabaseStore) UpdateEventStatus(ctx context.Context, eventID string, newStatus model.InternalStatus) error {
	...
	// Use semantic update method from store-client-sdk
