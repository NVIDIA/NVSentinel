...
type PlatformConnectorClient interface {
	HealthEventOccuredV1(ctx context.Context, in *HealthEvents, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *platformConnectorClient) HealthEventOccuredV1(ctx context.Context, in *HealthEvents, opts ...grpc.CallOption) (*empty.Empty, error) {
...
type PlatformConnectorServer interface {
	HealthEventOccuredV1(context.Context, *HealthEvents) (*empty.Empty, error)
...
func (UnimplementedPlatformConnectorServer) HealthEventOccuredV1(context.Context, *HealthEvents) (*empty.Empty, error) {
