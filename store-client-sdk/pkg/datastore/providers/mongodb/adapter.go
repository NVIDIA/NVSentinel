...
func (a *AdaptedMongoStore) InsertMany(ctx context.Context, documents []interface{}) error {
	// Use our existing client for bulk inserts
	// This would need to be implemented based on the specific bulk insert requirements
	return fmt.Errorf("InsertMany not yet implemented for MongoDB adapter")
}
