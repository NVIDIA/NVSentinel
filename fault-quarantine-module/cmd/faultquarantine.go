...
import (
	...
	"gitlab-master.nvidia.com/dgxcloud/mk8s/k8s-addons/nvsentinel/fault-quarantine-module/pkg/reconciler"
...
func main() {
	...
	k8sClient, err := reconciler.NewK8sClient(*kubeconfigPath)
	if err != nil {
