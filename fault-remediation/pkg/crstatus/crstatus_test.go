...
func TestShouldSkipCRCreation_DoesNotMatchOtherComponentOverride(t *testing.T) {
	...
	assert.False(t, shouldSkip, "expected checker to ignore a CR belonging to another component override")
}
