...
func TestK8sNodeConditions(t *testing.T) {
	healthEvents := []*healthConditionList{
		...
		},
		{
			...
			ExpectedOutputMessage:       "DCGM_FR_PCI_REPLAY_RATE:0 Recommended Action=UNKNOWN.",
		...
		},
		{
			...
			ExpectedOutputMessage:       "XID44:0 Recommended Action=REPORT_ISSUE.",
		...
		},
		{
			...
			ExpectedOutputMessage:       "XID44:0 Recommended Action=REPORT_ISSUE. XID45:0 Recommended Action=NONE.",
			ExpectedOutputReason:        "XidErrorDetected",
			ExpectedOutputConditionType: "XidError",
			ExpectedHealthFailureStatus: "True",
		},
		{
			healthEvent: &platformconnector.HealthEvent{
				...
				IsHealthy:          false,
				EntitiesImpacted:   []string{"0"},
				ErrorCode:          []string{"DCGM_FR_EC_HARDWARE_MEMORY"},
				IsFatal:            true,
				GeneratedTimestamp: timestamppb.New(time.Now()),
				ComponentClass:     "gpu",
				RecommendedAction:  platformconnector.RecommenedAction_UNKNOWN,
			},
			ExpectedOutputMessage:       "DCGM_FR_EC_HARDWARE_MEMORY:0 Recommended Action=UNKNOWN.",
